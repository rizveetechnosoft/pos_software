...
<script>
    ...
    function changeURL(){
        ...
        $('#bkash_payment_button').attr('href', 'https://bkash.sumondutta.com/bkash/payment?packageId='+package_id+'&packageName='+package_name+'&price='+price+'&userName='+user_name+'&id='+user_id+'&from=restaurant');
    }
</script>
