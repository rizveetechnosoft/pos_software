...
Route::middleware('web', 'auth', 'language', 'AdminSidebarMenu', 'superadmin')->prefix('superadmin')->group(function () {
    ...
    Route::get('/business/{id}/client-login', [Modules\Superadmin\Http\Controllers\BusinessController::class, 'client_login']);
    ...
    Route::resource('/frontend-pages', 'Modules\Superadmin\Http\Controllers\PageController');
     ...
     //Super admin Notice
        Route::get('/notice', [Modules\Superadmin\Http\Controllers\SuperadminNoticeController::class, 'edit']);
        Route::post('/notice/update', [Modules\Superadmin\Http\Controllers\SuperadminNoticeController::class, 'update']);
});
