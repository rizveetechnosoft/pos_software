...
class CashRegisterController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $current_register_received = $register_details->total_sale - $register_details->previous_due_received;
        $current_register_due = $details['transaction_details']->total_sales - $current_register_received;

        return view('cash_register.register_details')
                    ->with(compact('register_details', 'details', 'payment_types', 'close_time', 'current_register_due'));
    }
    ...
    public function getCloseRegister($id = null)
    {
        ...
        return view('cash_register.close_register_modal')
                    ->with(compact('register_details', 'current_register_due', 'details', 'payment_types', 'pos_settings'));
    }
