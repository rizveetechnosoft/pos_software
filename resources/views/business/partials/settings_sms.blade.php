    ...
    <div class="row">
        <div class="col-xs-3">
            <div class="form-group">
                ...
                {!! Form::select('sms_settings[sms_service]', ['bulksmsbd' => 'Bulk Sms BD', 'nexmo' => 'Nexmo', 'twilio' => 'Twilio',  'other' => __('lang_v1.other')], $sms_service , ['class' => 'form-control', 'id' => 'sms_service']); !!}
            </div>
        </div>
    </div>

    <div class="row sms_service_settings @if($sms_service != 'bulksmsbd') hide @endif" data-service="bulksmsbd">
        <div class="col-xs-3">
            <div class="form-group">
                {!! Form::label('bulksmsbd_api_key', __('lang_v1.bulksmsbd_api_key') . ':') !!}
                {!! Form::text('sms_settings[bulksmsbd_api_key]', !empty($sms_settings['bulksmsbd_api_key']) ? $sms_settings['bulksmsbd_api_key'] : null, ['class' => 'form-control','placeholder' => __('lang_v1.bulksmsbd_api_key'), 'id' => 'bulksmsbd_api_key']); !!}
            </div>
        </div>
        <div class="col-xs-3">
            <div class="form-group">
                {!! Form::label('bulksmsbd_sender_id', __('lang_v1.bulksmsbd_sender_id') . ':') !!}
                {!! Form::text('sms_settings[bulksmsbd_sender_id]', !empty($sms_settings['bulksmsbd_sender_id']) ? $sms_settings['bulksmsbd_sender_id'] : null, ['class' => 'form-control','placeholder' => __('lang_v1.bulksmsbd_sender_id'), 'id' => 'bulksmsbd_sender_id']); !!}
            </div>
        </div>
        ...
        <div class="col-md-4 col-xs-12">
            <div class="form-group">
                <div class="">
                    {!! Form::label('test_bulksmsbd_number', __('lang_v1.test_number') . ':') !!}
                    {!! Form::text('test_bulksmsbd_number', null, ['class' => 'form-control','placeholder' => __('lang_v1.test_number'), 'id' => 'test_bulksmsbd_number']); !!}
                </div>
            </div>
        </div>
        <div class="col-md-8 col-xs-12">
            <div class="form-group">
                <div class="">
                    {!! Form::label('test_bulksmsbd_message', __('lang_v1.test_message') . ':') !!}
                    {!! Form::text('test_bulksmsbd_message', null, ['class' => 'form-control','placeholder' => __('lang_v1.test_message'), 'id' => 'test_bulksmsbd_message']); !!}
                </div>
            </div>
        </div>
        <div class="col-md-4 col-xs-12">
            <div class="form-group">
                <div class="">
                    <span class="input-group-btn">
                        <button type="button" class="btn btn-success " id="test_bulksmsbd_sms_btn">@lang('lang_v1.test_sms_configuration')</button>
                    </span>
                </div>
            </div>
        </div>
