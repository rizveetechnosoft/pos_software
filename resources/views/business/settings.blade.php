        ...
        <div class="col-xs-12 pos-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item text-center">@lang('lang_v1.courier_settings')</a>
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                ...
                @include('business.partials.settings_courier')
                <!-- tab 10 end -->
                <!-- tab 11 start -->
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#test_bulksmsbd_sms_btn').click( function() {
            var test_bulksmsbd_number   = $('#test_bulksmsbd_number').val(); 

            if (test_bulksmsbd_number.trim() == '') {
                toastr.error('{{__("lang_v1.test_number_is_required")}}');
                $('#test_bulksmsbd_number').focus();

                return false;
            }

            var data = {
                test_bulksmsbd_number   : test_bulksmsbd_number,
                test_bulksmsbd_message  : $('#test_bulksmsbd_message').val(),
            };

            $.ajax({
                method: 'post',
                data: data,
                url: "{{ action([\App\Http\Controllers\BusinessController::class, 'testSmsConfigurationBulkSmsBD']) }}",
                dataType: 'json',
                success: function(result) {
                    if (result.success == true) {
                        swal({
