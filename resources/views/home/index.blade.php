...
<section class="content-header content-header-custom" style="background:#00c0ef !important ">
        ...
        @if($is_admin)
        	<div class="row">
                @if (session('notification'))
                    <div class="col-sm-12">
                        <div class="alert {{ session('notification.success') == 1 ? 'alert-success' : 'alert-danger' }} alert-dismissible">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        ...
                        <span class="info-box-icon bg-green">
                            ...
                            <div class="info-box-content">
                            <span class="info-box-text">{{ __('lang_v1.net_profit') }} @show_tooltip(__('lang_v1.net_home_tooltip'))</span>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        ...
                        <span class="info-box-icon bg-yellow">
                            ...
                            <span class="info-box-text">{{ __('home.account_receivable') }}</span>
            ...
            {{-- Newly added row for cash_in_hand, stock_in_hand, account_payable, and account_receivable --}}
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        ...
                        <div class="info-box-content">
                          ...
                          <span class="text-bold t_sell" data-translation="{{ __('home.total_sell') }}"></span> <br>
                          <span class="text-bold sell_return" data-translation="{{ __('home.sell_return') }}"></span>
                        </div>
                   </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('home.purchase') }}</span>
                          <span class="text-bold total_purchase" data-translation="{{ __('home.total_purchase') }}"></span> <br>
                          <span class="text-bold purchase_return" data-translation="{{ __('home.purchase_return') }}"></span>
                        </div>
                   </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('home.expense') }}</span>
                          <span class="text-bold t_total_expense" data-translation="{{ __('home.total_expense') }}"></span> <br>
                          <span class="text-bold t_expense_due" data-translation="{{ __('home.expense_due') }}"></span>
                        </div>
                   </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('home.profit') }}</span>
                          <span class="text-bold gross_profit" data-translation="{{ __('home.gross_profit') }}"></span> <br>
                          <span class="text-bold net_profit" data-translation="{{ __('home.net_profit') }}"></span>
                        </div>
                   </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        ...
                        <div class="info-box-content">
                          {{-- <span class="info-box-text">{{ __('home.account_payable') }}</span> --}}
                          <span class="info-box-text t_account_payable" data-translation="{{ __('home.account_payable') }}"></span>
                          <span class="text-bold purchase_due" data-translation="{{ __('home.purchase_due') }}"></span> <br>
                          <span class="text-bold expense_due" data-translation="{{ __('home.expense_due') }}"></span> <br>
                          <span class="text-bold sell_return_due" data-translation="{{ __('home.sell_return_due') }}"></span>
                        </div>

                        {{-- <p class="mb-0 text-muted fs-10 mt-5">
                            {{ __('home.initial_balance')}}: <span class="initial_balance"></span><br>
                            {{ __('home.cash_received')}}: <span class="cash_received"></span>
                        </p> --}}
                   </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        ...
                        <div class="info-box-content">
                          {{-- <span class="info-box-text">{{ __('home.account_receivable') }}</span> --}}
                          <span class="info-box-text t_account_receivable" data-translation="{{ __('home.account_receivable') }}"></span>
                          <span class="text-bold sell_due" data-translation="{{ __('home.sell_due') }}"></span> <br>
                          <span class="text-bold purchase_return_due" data-translation="{{ __('home.purchase_return_due') }}"></span>
                        </div>
                   </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('home.stock') }}</span>
                          <span class="text-bold stock_by_sell" data-translation="{{ __('home.stock_by_sell') }}"></span> <br>
                          <span class="text-bold stock_by_purchase" data-translation="{{ __('home.stock_by_purchase') }}"></span>
                        </div>
                   </div>
                </div>
                ...
                {{-- <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('home.cash_flow') }}</span>
                          <span class="text-bold cash_in_hand" data-translation="{{ __('home.cash_in_hand') }}"></span> <br>
                          <span class="text-bold digital_payment" data-translation="{{ __('home.digital_payment') }}"></span> <br>
                          <span class="text-bold external_payment" data-translation="{{ __('home.external_payment') }}"></span> <br>
                        </div>
                   </div>
                </div> --}}
                ...
                {{-- <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                       <span class="info-box-icon bg-aqua">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('home.stock_in_hand') }} @show_tooltip(__('lang_v1.net_home_tooltip'))</span>
                          <span class="info-box-number stock_in_hand"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        </div>
                    </div>
                </div> --}}
                ...
                {{-- <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                       <span class="info-box-icon bg-yellow">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('home.account_payable') }}</span>
                          <span class="info-box-number account_payable"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        </div>
                    </div>
                </div> --}}
                ...
                {{-- <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">
                            {{ __('home.account_receivable') }}
                          </span>
                          <span class="info-box-number account_receivable"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        </div>
                    </div>
                </div> --}}
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <div class="box-body" style="max-height: 340px; min-height:340px; overflow-y:auto">
