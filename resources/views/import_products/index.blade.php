        ...
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.instructions')])
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>25</td>
                        <td>@lang('lang_v1.enable_product_description_while_selling') <small class="text-muted">(@lang('lang_v1.optional'), @lang('lang_v1.default'): 0)</small></td>
                    ...
                    <tr>
                        <td>38</td>
                        <td>@lang('lang_v1.product_imei_or_sn') <small class="text-muted">(@lang('lang_v1.optional'), @lang('lang_v1.default'): 0)</small></td>
                        <td><strong>1 = @lang('messages.yes')<br>
                            0 = @lang('messages.no')</strong><br>
                        </td>
                    </tr>
