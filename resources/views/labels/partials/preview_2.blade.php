		...
		<td align="center" valign="center">
			<div style="overflow: hidden !important;display: flex; flex-wrap: wrap;align-content: center;width: {{$barcode_details->width * 1}}in; height: {{$barcode_details->height * 1}}in; justify-content: center;">
				...
				<div style="width: 95%; ">
					...
					{{-- weight --}}
					@if(!empty($print['weight']) && !empty($page_product->weight))
						<span style="font-size: {{$print['weight_size']}}px">
					...
					@endif
					{{-- Barcode --}}
					<img style="width:100% !important;height: {{$barcode_details->height*0.3}}in !important; display: block;" src="data:image/png;base64,{{DNS1D::getBarcodePNG($page_product->sub_sku, $page_product->barcode_type, 1,30, array(0, 0, 0), false)}}">

					{{--                    SKU --}}
					@if(!empty($print['sku']) )
						{{--                        <span style="font-size: 7px !important">--}}
						<span style="font-size: {{$print['sku_size']}}px">
