				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td>
							<div class="checkbox">
								<label>
									<input type="checkbox" name="print[sku]" value="1"> <b>@lang( 'lang_v1.print_sku' )</b>
								</label>
							</div>
						...
						<td>
							<div class="checkbox">
								<label>
									<input type="checkbox" name="print[weight]" value="1"> <b>@lang( 'lang_v1.weight' )</b>
								</label>
							</div>
