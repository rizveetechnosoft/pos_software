@foreach( $variations as $variation)
    <tr @if(!empty($purchase_order_line)) data-purchase_order_id="{{$purchase_order_line->transaction_id}}" @endif @if(!empty($purchase_requisition_line)) data-purchase_requisition_id="{{$purchase_requisition_line->transaction_id}}" @endif>
        <td>
            ...
            <input type="hidden" class="row_number" value="{{ $row_count }}">
            <input type="hidden" class="has_imei" value="{{ $product->has_imei }}">
        </td>
        <td>
        ...
        <td class="imei_td">
            @if ($product->has_imei)
                <input type="text" name={{ 'purchases[' . $row_count . '][imei_numbers][0][imei_1]' }} id="" class="form-control input-sm" placeholder="IMEI 01" required> <br>
                <input type="text" name={{ 'purchases[' . $row_count . '][imei_numbers][0][imei_2]' }} id="" class="form-control input-sm" placeholder="IMEI 02">
            @else
                <p>No IMEI</p>                
            @endif
        </td>
