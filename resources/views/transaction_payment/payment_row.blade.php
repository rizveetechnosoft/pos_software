  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row payment_row">
        ...
        @if($show_external_payment_check ?? false)
          <div class="col-md-4">
            <div class="form-group">
              <div class="input-group">
                {!! Form::checkbox('external_payment', 1, false, ['class' => 'input-icheck', 'id' => 'external_payment']); !!} <strong>@lang('cash_register.external_payment')</strong>
              </div>
            </div>
          </div>
        @endisset
