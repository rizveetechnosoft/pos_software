...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/test-sms-bulkSmsBD', [BusinessController::class, 'testSmsConfigurationBulkSmsBD']);
    ...
    Route::get('/user/update-language', [UserController::class, 'updateLanguage'])->name('user.updateLanguage');
    ...
    Route::post('/product_imeis/ajax_update', [ProductController::class, 'ajaxUpdateProductImei'])->name('product_imei.ajax_update');
    ...
    Route::get('purchases/{id}/imeis', [App\Http\Controllers\PurchaseController::class, 'imeis'])->name('purchases.imeis');
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/sells/{id}/send-to-courier', [SellController::class, 'sendToCourier'])->name('sell.sendToCourier');
    Route::post('/sells/{id}/send-to-courier', [SellController::class, 'postCourierOrder'])->name('sell.postCourierOrder');
    Route::get('/sells/{id}/show-courier-info', [SellController::class, 'showCourierInfo'])->name('sell.showCourierInfo');
    
    Route::get('/pathao_courier/cities/{city_id}/zone-list', [SellController::class, 'getZones'])->name('pathao_courier.getZones');
});